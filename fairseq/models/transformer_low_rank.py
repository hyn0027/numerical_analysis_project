...
@register_model("transformerLowRank")
class TransformerLowRankModel(TransformerModelBase):
    """
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument(
            '--low-rank', type=str, choices=['none', 'SVD', 'PCA'], required=True,
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return TransformerLowRankEncoderBase(TransformerConfig.from_namespace(args), src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        cfg = TransformerConfig.from_namespace(args)
        return TransformerLowRankDecoderBase(
            cfg,
            tgt_dict,
            embed_tokens,
...
class TransformerLowRankEncoderBase(TransformerEncoderBase):
    """
    ...
    def build_encoder_layer(self, cfg):
        layer = transformer_low_rank_layer.TransformerLowRankEncoderLayerBase(
...
@register_model_architecture("transformerLowRank", "transformerLowRank_tiny")
...
@register_model_architecture("transformerLowRank", "transformerLowRank")
...
@register_model_architecture("transformerLowRank", "transformerLowRank_iwslt_de_en")
...
@register_model_architecture("transformerLowRank", "transformerLowRank_wmt_en_de")
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("transformerLowRank", "transformerLowRank_vaswani_wmt_en_de_big")
...
@register_model_architecture("transformerLowRank", "transformerLowRank_vaswani_wmt_en_fr_big")
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, "dropout", 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture("transformerLowRank", "transformerLowRank_wmt_en_de_big")
...
@register_model_architecture("transformerLowRank", "transformerLowRank_wmt_en_de_big_t2t")
